  ...
  return (
    <div className="Contact">
      <div className="container-1">
        <span>Contact</span>
        <div className="text">
          <h1> Wujudkan Seragam Impian Komunitas?</h1>
          <ContactDialog whatsappNumber={process.env.NEXT_PUBLIC_WA} buttonText="Hubungi Kami" buttonClass="btn-s" buttonVariant="outline" />
        </div>
      </div>
