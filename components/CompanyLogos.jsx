    ...
    <div className="companylogos">
      <div className="container">
        <Marquee pauseOnHover gradient={false}>
          {/* Gabungkan array dengan dirinya sendiri untuk membuat loop yang mulus */}
          {[...companyLogo, ...companyLogo].map((elem, index) => (
            <img src={elem} alt={`Client Logo ${index + 1}`} key={index} />
          ))}
        </Marquee>
      </div>
    </div>
